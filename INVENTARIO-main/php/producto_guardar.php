...
$descripcion = limpiar_cadena($_POST['producto_descripcion']); // Nuevo campo

/*== Verificando campos obligatorios ==*/
if ($codigo == "" || $nombre == "" || $precio == "" || $stock == "" || $categoria == "" || $descripcion == "") {
    echo '
...
$guardar_producto = $guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,producto_descripcion,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:descripcion,:categoria,:usuario)");
